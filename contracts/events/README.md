...
- [`company-member.role_changed.v1.json`](company-member.role_changed.v1.json) - published by `services/company-members-service`.
...
- [`company-specialist.removed.v1.json`](company-specialist.removed.v1.json) - published by `services/company-specialists-service`.
