...
import type { CreateServiceRequest, ListPublicServicesQuery, UpdateServiceRequest } from '@/autogenerated/types/index.js';
...
export const publicServicesQuerySchema: z.ZodType<ListPublicServicesQuery> = paginationQuerySchema.extend({
