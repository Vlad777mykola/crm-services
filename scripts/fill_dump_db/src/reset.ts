...
export const SEEDED_TABLES = [
  ...
  'appointments_schema.company_time_blocks',
  'appointments_schema.specialist_time_blocks',
...
export const RESETTABLE_APPLICATION_TABLES = [
  ...
  'appointments_schema.company_availability_rules',
  'appointments_schema.company_time_blocks',
  'appointments_schema.specialist_availability_rules',
  'appointments_schema.specialist_time_blocks',
  'appointments_schema.client_profiles_projection',
