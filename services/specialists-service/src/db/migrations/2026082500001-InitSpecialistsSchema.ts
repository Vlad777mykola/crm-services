...
export class InitSpecialistsSchema2026082500001 implements MigrationInterface {
  name = 'InitSpecialistsSchema2026082500001';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE SCHEMA IF NOT EXISTS specialists_schema`);
    ...
    `);
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_specialist_status_history_profileId"
      ON specialists_schema.specialist_status_history ("specialistProfileId")
    `);
    ...
    `);
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_specialists_outbox_events_status"
      ON specialists_schema.outbox_events ("status")
    `);
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_specialists_outbox_events_nextRetryAt"
      ON specialists_schema.outbox_events ("nextRetryAt")
    `);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP TABLE IF EXISTS specialists_schema.outbox_events`);
    await queryRunner.query(`DROP TABLE IF EXISTS specialists_schema.public_specialist_rating_summary`);
    await queryRunner.query(`DROP TABLE IF EXISTS specialists_schema.public_specialist_service_projection`);
    await queryRunner.query(`DROP TABLE IF EXISTS specialists_schema.public_service_projection`);
    await queryRunner.query(`DROP TABLE IF EXISTS specialists_schema.public_specialist_company_projection`);
    await queryRunner.query(`DROP TABLE IF EXISTS specialists_schema.public_company_projection`);
    await queryRunner.query(`DROP TABLE IF EXISTS specialists_schema.processed_events`);
    await queryRunner.query(`DROP TABLE IF EXISTS specialists_schema.specialist_status_history`);
    await queryRunner.query(`DROP TABLE IF EXISTS specialists_schema.specialist_profiles`);
  }
}
