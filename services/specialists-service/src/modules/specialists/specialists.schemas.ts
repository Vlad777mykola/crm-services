...
import type {
  ...
  PublicSpecialistsQuery,
  SpecialistIdParams,
  UpdateSpecialistProfileRequest,
} from './specialists.contracts.js';
...
export const publicSpecialistsQuerySchema: z.ZodType<PublicSpecialistsQuery> = paginationQuerySchema.extend({
