...
import type { ApproveAppointmentCommand } from './approve-appointment.command.js';
...
export class ApproveAppointmentHandler {
  ...
  async execute(command: ApproveAppointmentCommand): Promise<AppointmentResponse> {
    ...
    assertTransitionAllowed(fromStatus, 'approved', 'This appointment has already been responded to');
